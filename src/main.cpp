...
uint256 hashGenesisBlock("0x00000ba74af732d2d56aeab4b94a6af5d5515e01d76fc8c881ad955372a06d8f");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // AntarcticCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "AntarcticCoin Signed Message:\n";
...
{
    // AntarcticCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	if (nHeight <= 4 && nHeight > 0)
    {
        nSubsidy = 1800000 * COIN;
    }
	else if (nHeight <= 300 && nHeight > 4)
    {
        nSubsidy =1000 * COIN;
    }
	else if (nHeight <= 1440 && nHeight > 300)
    {
        nSubsidy =16111 * COIN;
    }
...
static const int64 nTargetTimespan = 50 * 60; // AntarcticCoin: 1 day
static const int64 nTargetSpacing = 60; // AntarcticCoin: 1 minute
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // AntarcticCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
{
        static const int64 BlocksTargetSpacing = 60; // AntarcticCoin: 1 minute
        static const unsigned int TimeDaySeconds = 50 * 60; // AntarcticCoin: 1 day
...
{
    // AntarcticCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = " 14/May/2014 the coins coming from En ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1400058456;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1240139201;
        ...
        assert(block.hashMerkleRoot == uint256("0xb1212caf72f1b775483b1e48f1559c6822deaa74b000551dd0b95b3d7c8ad7cb"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xb9, 0xde }; // AntarcticCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AntarcticCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AntarcticCoinMiner : ProcessBlock, block not accepted");
    }
