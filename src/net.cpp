...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "AntarcticCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"114.215.173.19", "114.215.173.19"},
		 {"58.64.153.182", "58.64.153.182"},
		 {"162.211.181.165", "162.211.181.165"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. AntarcticCoin is probably already running."), addrBind.ToString().c_str());
        else
